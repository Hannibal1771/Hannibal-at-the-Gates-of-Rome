...
<head>
	...
	$(document).ready(function() {
		$("#done").click (function(){
			...
			var fail="";
			if (name.length < 8) fail = "Имя не меньше 8 символов";
				else if (email.split('@').length -1 == 0 || email.split('.').length -1==0)
					fail = "Вы ввели некорректный email";
				else if (subject.length < 8) 
					fail = "Тема сообщения не менее 8 символов";
...
<body>
	...
	<div id="wrapper">
		<div id="leftCol">
			...
			<input type="text" placeholder="Адрес электронной почты" id="email" name="email"><br/>
